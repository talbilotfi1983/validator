...
public class GenerateInfoNotice {
    ...
    public String toString() {
        return "GenerateInfoNotice{" +
                "resultRepo=" + resultRepo +
                ", execParamRepo=" + execParamRepo +
                ", gtfsDataRepo=" + gtfsDataRepo +
                ", timestamp=" + timestamp +
                ", processingTimeSecs=" + processingTimeSecs +
                ", processedFilenameCollection=" + processedFilenameCollection +
